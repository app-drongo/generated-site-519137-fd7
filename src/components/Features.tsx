...
// Generated: 2025-08-20T17:05:03.123Z
// Section: features
// Category: features
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
            ...
            <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
              FinanceSmart's Powerful Features
            </span>
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Discover how our comprehensive suite of features can help you streamline your financial operations, 
            enhance security, and drive growth for your small or medium-sized business.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <p className="text-muted-foreground mb-4">
            Ready to transform your business with FinanceSmart?
          </p>
